        ...
        return (
          <Container className="pt-5">
            <Card  style={{ width: "28rem", marginBottom: "20px" }}
              ...
              />
              <Card.Body>
                <Card.Title  className="cardTitleText1">{e.article.title}</Card.Title> 
                {/* <Button className="btn btn-danger"
                  ...
                  <Button variant="outline-dark" style={{ marginBottom:'10px'}}
                  onClick={() => {
                ...
                >
                  ...
                  <svg onClick={()=>{
                      ...
                      xmlns="http://www.w3.org/2000/svg" width="" height="20" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
